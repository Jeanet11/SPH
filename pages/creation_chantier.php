...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-sm-4"><label class="col-sm-offset-4" for="nom_du_chantier">nom du chantier :</label><input type="text" class="form-control input-lg" id="nom_du_chantier"  name="nom_du_chantier" value=" "></div>
    </div>
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <input class="col-sm-offset-4 hidden-xs" type="submit" value="envoyer"></div>
            </div>
            ...
            <div class="col-sm-4"><label class="col-sm-4" for="montant">montant :</label><input type="text" class="form-control input-lg" id="montant" name="montant"></div>
                ...
                <div class="col-sm-12"><label class="col-sm-12"  for="notes">notes :</label><textarea class="form-control input-lg" id="notes" name="notes" rows="8"></textarea> 
                    ...
                    <input class="col-sm-offset-4 visible-xs" type="submit" value="envoyer"></div>                     
    </form>
</div>      
